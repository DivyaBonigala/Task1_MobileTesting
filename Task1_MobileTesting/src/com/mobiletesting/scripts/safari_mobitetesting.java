...
public class safari_mobitetesting extends safari_browsersetting{
...
public void website_open()
{
    ...
    Thread.sleep(3000);
    System.out.println("adjusting the resolution for safari");
    driver.manage().window().setSize(new Dimension(360, 640));
    System.out.println("Window size set to: " + driver.manage().window().getSize());
    Thread.sleep(2000);
    
    String folder360 ="/Users/divyabonigala/eclipse-workspace/Task1_MobileTesting/Mobile_safari_images/360X640";
...
try
{
    ...
    String folder414="/Users/divyabonigala/eclipse-workspace/Task1_MobileTesting/Mobile_safari_images/414X896";
...
try
{
    ...
    String folder375 ="/Users/divyabonigala/eclipse-workspace/Task1_MobileTesting/Mobile_safari_images/375X667";
